...
<form name="form1" method="post" action="<?=base_url()?>index.php/category/add" enctype="multipart/form-data"/>
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
       ...
       <td colspan="2">
         <input type="text" name="c_name" class="form-control"  placeholder="分类名称"> <span class="label label-danger">必填</span>
       </td>
  </tr>
    <tr>
